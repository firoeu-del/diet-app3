                ...
                return ft.Card(
                    content=ft.Container(
                        ...
                        content=ft.Column([
                            ...
                            ft.Divider(),
                            # ✅ آیکون‌های اصلاح‌شده
                            ft.Row([ft.Icon(ft.icons.GRAIN), ft.Text(f"نان و غلات: {b} واحد")]),
                            ft.Row([ft.Icon(ft.icons.SET_MEAL), ft.Text(f"گوشت و پروتئین: {m}")]),
                            ft.Row([ft.Icon(ft.icons.ENERGY_SAVINGS_LEAF), ft.Text(f"میوه: {u_fruit} | لبنیات: {u_milk} | سبزی: {u_veg}")]),
                            ft.Row([ft.Icon(ft.icons.OPACITY), ft.Text(f"چربی: {f1} | قند ساده: {s}")]),
                        ])
                    )
                )
